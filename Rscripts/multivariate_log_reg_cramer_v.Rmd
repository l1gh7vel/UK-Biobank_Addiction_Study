...
This file has code to do multivariate logistic regressions with cramer's V association removal for the SNPs selected after lasso and SNP-SNP interactions found in SNPAssoc for each of the groups (male, female, overall in main and sub studies)
